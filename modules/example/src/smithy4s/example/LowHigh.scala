...
sealed abstract class LowHigh(_value: String, _name: String, _intValue: Int, _hints: Hints, _enumerationHints: Hints) extends Enumeration.Value {
...
object LowHigh extends Enumeration[LowHigh] with ShapeTag.Companion[LowHigh] {
  ...
  case object LOW extends LowHigh("Low", "LOW", 0, Hints(), hints)
  case object HIGH extends LowHigh("High", "HIGH", 1, Hints(), hints)
