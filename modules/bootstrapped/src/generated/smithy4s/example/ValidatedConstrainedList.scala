...
object ValidatedConstrainedList extends ValidatedNewtype[List[String]] {
  ...
  val validator: Validator[List[String], ValidatedConstrainedList] = Validator.of[List[String], ValidatedConstrainedList](Bijection[List[String], ValidatedConstrainedList](_.asInstanceOf[ValidatedConstrainedList], value(_))).validating(smithy.api.Length(min = None, max = Some(1L)))
