...
object ValidatedRefinedPrimitive extends Newtype[smithy4s.refined.Name] {
  ...
  implicit val schema: Schema[ValidatedRefinedPrimitive] = bijection(underlyingSchema, asBijection)
}
